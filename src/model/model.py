...
def train_test_split_unbalanced(data, target_column, sampling_strategy="smote", sort_by_date=True, train_ratio=0.8, random_state=0, drop_columns=[]):
    ...
    return x_train.drop(columns=drop_columns), x_test.drop(columns=drop_columns), y_train, y_test
